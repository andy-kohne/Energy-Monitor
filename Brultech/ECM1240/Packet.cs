...
public class Packet
{
    ...
    public static void ValidatePacket(ReadOnlySpan<byte> packetBytes)
    {
    ...
    public Packet(ReadOnlySpan<byte> packetBytes)
    {
        ...
        DeviceAddress = packetBytes.GetUShort(29);
        ...
        Ch1Current = (decimal)packetBytes.GetBigEndianUShort(33) / 100;
        //ch2 current: byte 35 (LSB) -> byte 36 (MSB)
        Ch2Current = (decimal)packetBytes.GetBigEndianUShort(35) / 100;
        ...
        DcVoltage = (decimal)packetBytes.GetBigEndianUShort(60) / 100;
